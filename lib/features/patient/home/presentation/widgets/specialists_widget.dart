...
import 'package:se7ty_app/features/patient/home/data/specialization_model.dart';
import 'package:se7ty_app/features/patient/home/presentation/page/specialization_search_screen.dart';
...
class SpecialistsBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text("التخصصات", style: TextStyles.titleStyle(fontFamily: "Cairo").copyWith(fontSize: 16)),
        SizedBox(
          height: 230,
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return GestureDetector(
                onTap: () {
               pushTo(context , const SpecializationSearchScreen(specialization: 'Cardiology'));
                },
