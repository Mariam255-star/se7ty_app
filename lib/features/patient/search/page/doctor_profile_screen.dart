...
import 'package:se7ty_app/features/patient/search/widgets/item_tile.dart';
import 'package:se7ty_app/features/patient/search/widgets/phone_tile.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyles.titleStyle(fontFamily:  "Cairo").copyWith(fontSize: 20),
                        ),
              ...
              const SizedBox(height: 10),
              Text(widget.doctorModel?.bio ?? '', style: TextStyles.bodyStyle()),
              const SizedBox(height: 20),
              Container(
      ...
      bottomNavigationBar: SafeArea(
        child: Padding(
          ...
          child: MainButton(
            text: 'احجز موعد الان',
            onPressed: () {
             pushTo(context, DoctorModel() as Widget);
            },
          ),
        ),
      ),
